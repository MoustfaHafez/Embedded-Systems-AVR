...
UARTTASK_Type arr[size]={{"LEDON",&LEDONN},{"LEDOFF",&LEDOFFF},{"MOTORON",&MOTORON},{"MOTOROFF",&MOTOROFF}};
...
static void MOTORON(u8 num)
{
	...
	{
		case 0:
		DIO_VidWritePin(PINC3,High);
		break;
		case 1:
		DIO_VidWritePin(PINC4,High);
		break;
	}
}
...
static void MOTOROFF(u8 num)
{
	...
	{
		case 0:
		DIO_VidWritePin(PINC3,Low);
		break;
		case 1:
		DIO_VidWritePin(PINC4,Low);
		break;
	}
}
